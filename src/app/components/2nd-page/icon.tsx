...
import iconImage from "/2nd-page-pics/Meubel House_Logos-05.png"
...
const Icon = () => {
    return(
      ...
      >
        ...
        <Image src={"/2nd-page-pics/Meubel House_Logos-05.png"} width={77} height={77} alt="iconImage" className="  " />
